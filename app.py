...
uses Google Gemini (gemini-3.6-flash) to extract structured invoice data,
...
def get_gemini_client() -> "genai.Client":
    """Build a Google GenAI client (new unified SDK) from the resolved API key."""
...
def extract_invoice_data(pdf_text: str) -> dict:
    ...
    response = client.models.generate_content(
        model=MODEL_NAME,
        contents=f"Extract invoice details from this text:\n\n{pdf_text[:12000]}",
